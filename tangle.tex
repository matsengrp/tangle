...
Now we will describe the symmetries of a labeled tanglegram.
Assume a fixed planar embedding of a given $n$-tanglegram, and consider various labelings of it.
The direct product of the symmetric group acts by relabeling the leaves for each of the trees, and each such action defines a single tanglegram.
Any stabilizer of a given labeling can be expressed as a product of automorphisms of $t_1$ in the first component and the conjugate of automorphisms of $t_2$ via $\pairing$ in the second, and any such product is certainly a stabilizer.
...
Because we will only need this wreath product, I will just define this special case.
