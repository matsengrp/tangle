...
There is an action of $G$ on the right cosets $HgK$ by multiplication on the right:
\[
(HgK).g' := Hgg'K.
\]
This action is transitive, which is to say that every $(H,K)$ double coset arises in this way.
The stabilizer of a given $HgK$ is the group generated by the subgroup
