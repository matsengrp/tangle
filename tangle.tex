...
\section{Formalism}
Define isomorphism of leaf-labeled trees. Mapping of leaves to themselves that induces an isomorphism of the rest of the tree.
Contrast with graph isomorphism, which doesn't take labels into account.
Describe isomorphism graph theoretically versus phylogenetically?
...
\end{definition}
There is a clear 1-to-1 correspondence between isomorphism classes of tanglegrams under relabeling $(t_1, t_2, \pairing)$ and tanglegraphs (assuming they are considered up to graph isomorphism) by joining leaves of $t_1$ with their corresponding leaves in $t_2$ under $\pairing$.
