...
These labeled tanglegrams give the same tanglegram if there is an element of the symmetric group exchanging labels such that one tanglegram becomes another.
Assume a fixed planar embedding of a given $n$-tanglegram, and consider various labelings of it.
...
\[
G / |\langle \aut(t_1), \pairing \aut(t_2) \pairing^{-1} \rangle|.
\]
For stanglegrams the number is slightly smaller due the additional symmetry of exchanging $t_1$ and $t_2$:
\[
G / |\langle \aut(t_1), \pairing \aut(t_2) \pairing^{-1}, \pairing^{-1} \aut(t_2) \pairing \rangle|.
\]
...
Thus this number of labelings for tanglegrams (resp.\ stanglegrams) is equal to the number of labeled phylogenetic trees that can be used to make that tanglegram.
